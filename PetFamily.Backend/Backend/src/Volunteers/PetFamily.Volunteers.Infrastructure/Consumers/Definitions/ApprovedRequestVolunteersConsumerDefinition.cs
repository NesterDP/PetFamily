...
namespace PetFamily.Volunteers.Infrastructure.Consumers.Definitions;

public class ApprovedRequestVolunteersConsumerDefinition : ConsumerDefinition<ApprovedRequestVolunteersConsumer>
{
    protected override void ConfigureConsumer(
        IReceiveEndpointConfigurator endpointConfigurator,
        IConsumerConfigurator<ApprovedRequestVolunteersConsumer> consumerConfigurator,
