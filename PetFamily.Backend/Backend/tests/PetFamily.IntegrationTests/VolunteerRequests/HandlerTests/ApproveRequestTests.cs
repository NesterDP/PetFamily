...
public class ApproveRequestTests : VolunteerRequestsTestsBase
{
    ...
    public ApproveRequestTests(VolunteerRequestsWebFactory factory)
        : base(factory)
    {
    ...
    public async Task ApproveRequest_success_should_set_request_status_to_Approved_and_make_user_a_volunteer()
    {
        ...
        var consumer2 = harness
            .GetConsumerHarness<PetFamily.Accounts.Infrastructure.Consumers.ApprovedRequestAccountsConsumer>();
