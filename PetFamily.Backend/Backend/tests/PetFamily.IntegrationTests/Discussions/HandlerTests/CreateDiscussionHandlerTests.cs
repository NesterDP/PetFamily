...
public class CreateDiscussionHandlerTests : DiscussionsTestsBase
{
    ...
    public CreateDiscussionHandlerTests(DiscussionsWebFactory factory)
        : base(factory)
    {
    ...
    [Fact]
    public async Task
        CreateDiscussion_failure_should_return_error_because_discussion_with_such_relationId_already_exists()
    {
        // arrange
