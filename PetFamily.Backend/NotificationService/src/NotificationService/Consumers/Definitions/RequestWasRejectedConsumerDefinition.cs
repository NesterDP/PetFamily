...
public class RequestWasRejectedConsumerDefinition 
    : ConsumerDefinition<RequestWasRejectedConsumer>
{
    protected override void ConfigureConsumer(
        IReceiveEndpointConfigurator endpointConfigurator,
        IConsumerConfigurator<RequestWasRejectedConsumer> consumerConfigurator,
