...
public class RequestWasTakenOnReviewConsumerDefinition
    : ConsumerDefinition<RequestWasTakenOnReviewConsumer>
{
    protected override void ConfigureConsumer(
        IReceiveEndpointConfigurator endpointConfigurator,
        IConsumerConfigurator<RequestWasTakenOnReviewConsumer> consumerConfigurator,
